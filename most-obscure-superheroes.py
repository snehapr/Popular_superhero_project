...
names = spark.read.schema(schema).option("sep", " ").csv("file:///SparkCourse/Adv_Examples/popular_superhero/Marvel-Names.txt")

lines = spark.read.text("file:///SparkCourse/Adv_Examples/popular_superhero/Marvel-Graph.txt")
